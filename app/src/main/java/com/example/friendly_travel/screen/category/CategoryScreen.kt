...
import com.example.friendly_travel.components.dummyBestSellerMenu
import com.example.friendly_travel.components.dummyCategory
import com.example.friendly_travel.components.dummyMenu
...
import com.example.friendly_travel.screen.home.HomeSection
...
fun CategoryRow(
    ...
    LazyRow(
        ...
        items(dummyCategory, key = { it.textCategory }) { category ->
            com.example.friendly_travel.components.CategoryItem(category)
        }
    }
}
...
fun HomeContent(
    ...
    Column(
        ...
        HomeSection(
            title = stringResource(R.string.section_recomendation),
